<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Category_SideEffect" Title="Untitled Page" Codebehind="SideEffect.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h2>
        Danh mục phản ứng truyền máu
    </h2>
    <p>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucSupplierEditLocation.ascx.cs"
    Inherits="UserControl_SupplierEditLocation" %>
...
<div id="divGridViewLocation" style="float: left;">
    ...
    <asp:LinqDataSource ID="LinqDataSourceLocation" runat="server" ContextTypeName="RedBloodDataContext"
        TableName="SupplierLocations" Where="SupplierID == Guid(@SupplierID)" EnableDelete="True"
        EnableUpdate="True">
        <WhereParameters>
...
<div id="divContact" style="float: left; clear: both;">
    ...
    <asp:LinqDataSource ID="LinqDataSourceContact" runat="server" ContextTypeName="RedBloodDataContext"
        EnableDelete="True" EnableUpdate="True" OrderBy="FullName" TableName="SupplierContactPersons"

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucCustomerEditAccount.ascx.cs"
    Inherits="UserControl_CustomerEditAccount" %>
...
<asp:LinqDataSource ID="LinqDataSourceAccount" runat="server" ContextTypeName="RedBloodDataContext"
    EnableDelete="True" EnableUpdate="True" TableName="CustomerBankAccounts" Where="CustomerID == Guid(@CustomerID)">
    <WhereParameters>

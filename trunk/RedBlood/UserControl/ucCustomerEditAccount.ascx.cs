...
public partial class UserControl_CustomerEditAccount : System.Web.UI.UserControl
{
    public event EventHandler AccountChanged;

    CustomerBankAccountBLL bll = new CustomerBankAccountBLL();
    ...
    protected void GridViewBank_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        switch (e.CommandName)
        {
            case "AddAccount":
                ...
                bll.Insert(new Guid(txtCustomerID.Text), bankID);
    ...
    protected void GridViewAccount_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        switch (e.CommandName)
        {
            case "Select":
                ...
                customerBLL.Set_DefaultAccountID(new Guid(txtCustomerID.Text), accID);

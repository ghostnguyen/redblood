<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucCompanyEditAccount.ascx.cs"
    Inherits="UserControl_CompanyEditAccount" %>
...
<asp:LinqDataSource ID="LinqDataSourceAccount" runat="server" ContextTypeName="RedBloodDataContext"
    EnableDelete="True" EnableUpdate="True" TableName="CompanyBankAccounts" Where="CompanyID == Guid(@CompanyID)">
    <WhereParameters>

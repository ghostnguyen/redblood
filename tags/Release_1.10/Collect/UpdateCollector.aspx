...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
        ...
        <Columns>
            <asp:BoundField DataField="Autonum" InsertVisible="False" SortExpression="Autonum" />
            ...
            <asp:TemplateField HeaderText="Thành phần">
                <ItemTemplate>
                    <asp:Label ID="Label1" Text='<%# Eval("Component.Name") %>' runat="server"></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="RedBloodDataContext"
        TableName="Packs" OnSelecting="LinqDataSource1_Selecting" EnableUpdate="True">
    </asp:LinqDataSource>
    <br />
    <asp:Button ID="btnUpdate" runat="server" Text='<%$ Resources:Resource,Update %>'
        OnClick="btnUpdate_Click"  />
    <asp:Button ID="btnClear" runat="server" Text="Xóa danh sách" OnClick="btnClear_Click" BorderStyle="Solid" />
    <br />
    <br />
</asp:Content>

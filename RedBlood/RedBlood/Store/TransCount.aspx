<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TransCount.aspx.cs" Inherits="Store_TransCount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:GridView ID="GridViewStart" runat="server" DataSourceID="LinqDataSourceStart" AutoGenerateColumns="false">
        <Columns>

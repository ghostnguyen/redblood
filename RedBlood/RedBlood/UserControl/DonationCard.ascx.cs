...
public partial class UserControl_Envelope : System.Web.UI.UserControl
{
    ...
    {
        lblName.Text = e.Name;
        //lblName.Style.Add("top", PrintSettingBLL.Name.Top);
        //lblName.Style.Add("left", PrintSettingBLL.Name.Left);
        //lblName.Style.Add("font", PrintSettingBLL.Name.Font);
        //lblName.Style.Add("font-size", PrintSettingBLL.Name.Size);

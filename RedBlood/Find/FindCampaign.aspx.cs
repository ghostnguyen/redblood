...
public partial class Find_FindCampaign : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            sourceList.Add((int)TestDef.Source.Donation);
            sourceList.Add((int)TestDef.Source.RedCross);
            sourceList.Add((int)TestDef.Source.Other);
    ...
    protected void LinqDataSource1_Selecting(object sender, LinqDataSourceSelectEventArgs e)
    {
        ...
        List<Campaign> l = db.Campaigns.Where(r => from.Value.Date <= r.Date.Value.Date
            ...
            && sourceList.Contains(r.SourceID.Value)).ToList();

...
public partial class UserControl_CompanyEditLocation : System.Web.UI.UserControl
{
    CompanyLocationBLL locationBLL = new CompanyLocationBLL();
    CompanyContactPersonBLL contactBLL = new CompanyContactPersonBLL();
    ...
    protected void GridViewLocation_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        switch (e.CommandName)
        {
            case "Select":
                ...
                CompanyLocation l = locationBLL.Get_byID(ID);
    ...
    protected void ImageButtonNewLocation_Click(object sender, EventArgs e)
    {
        ...
        CompanyLocation lo = new CompanyLocation();
        lo.CompanyID = new Guid(txtCompanyID.Text);
        lo.Name = "Tên chi nhánh";

        db.CompanyLocations.InsertOnSubmit(lo);
        db.SubmitChanges();

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucCustomerEditLocation.ascx.cs"
    Inherits="UserControl_CustomerEditLocation" %>
...
<div id="divGridViewLocation" style="float: left;">
    ...
    <asp:LinqDataSource ID="LinqDataSourceLocation" runat="server" ContextTypeName="RedBloodDataContext"
        TableName="CustomerLocations" Where="CustomerID == Guid(@CustomerID)" EnableDelete="True"
        EnableUpdate="True">
        <WhereParameters>
...
<div id="divContact" style="float: left; clear: both;">
    ...
    <asp:LinqDataSource ID="LinqDataSourceContact" runat="server" ContextTypeName="RedBloodDataContext"
        EnableDelete="True" EnableUpdate="True" OrderBy="FullName" TableName="CustomerContactPersons"
        Where="CustomerLocation.CustomerID == Guid(@CustomerID)">
        <WhereParameters>
            <asp:ControlParameter ControlID="txtCustomerID" Name="CustomerID" PropertyName="Text"
                Type="Object" DefaultValue="{00000000-0000-0000-0000-000000000000}" />
        </WhereParameters>

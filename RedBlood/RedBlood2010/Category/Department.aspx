<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Category_Department" Title="Untitled Page" Codebehind="Department.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="float: left; margin-left: 10px; width: 30%;">
        ...
        <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="RedBlood.RedBloodDataContext"
            EnableDelete="True" EnableUpdate="True" TableName="Departments" Where="Level == @Level" OrderBy="Name">
            <WhereParameters>
    ...
    <div style="float: left; margin-left: 10px; width: 30%;">
        ...
        <asp:LinqDataSource ID="LinqDataSource2" runat="server" ContextTypeName="RedBlood.RedBloodDataContext"
            TableName="Departments" EnableDelete="True" EnableUpdate="True" Where="ParentID == Guid?(@ParentID) and Level == 2" OrderBy="Name">
            <WhereParameters>
    ...
    <div style="float: left; margin-left: 10px; width: 30%">
        ...
        <asp:LinqDataSource ID="LinqDataSource3" runat="server" ContextTypeName="RedBlood.RedBloodDataContext"
            EnableDelete="True" EnableUpdate="True" TableName="Departments" Where="ParentID == Guid?(@ParentID) and Level == 3" OrderBy="Name">
            <WhereParameters>

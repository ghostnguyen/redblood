...
<div id="DivUC" style="position: absolute;" runat="server">
    <asp:TextBox ID="lblLine1" runat="server" Style="position: absolute; border-top: 3px solid black;
        border-right: none; border-left: none; border-bottom: none;"></asp:TextBox>

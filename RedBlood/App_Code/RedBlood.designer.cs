...
public partial class Pack : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private System.Nullable<int> _DeliverStatus;
	
	private EntitySet<PackLink> _PackLinks;
	
	private EntitySet<PackLink> _PackLinks1;
    ...
    partial void OnVolumeChanging(System.Nullable<int> value);
    partial void OnVolumeChanged();
    partial void OnDeliverStatusChanging(System.Nullable<int> value);
	...
	[Column(Storage="_DeliverStatus", DbType="Int")]
	public System.Nullable<int> DeliverStatus
	{
		get
		{
	...
	[Association(Name="Pack_PackLink", Storage="_PackLinks", ThisKey="ID", OtherKey="FromPack")]
	public EntitySet<PackLink> PackLinks
	{
		get
		{
			return this._PackLinks;
		}
		set
		{
			this._PackLinks.Assign(value);
		}
	}
	
	[Association(Name="Pack_PackLink1", Storage="_PackLinks1", ThisKey="ID", OtherKey="ToPack")]
	public EntitySet<PackLink> PackLinks1
	{
		get
		{
			return this._PackLinks1;
		}
		set
		{
			this._PackLinks1.Assign(value);
		}
	}
	...
	private void attach_PackLinks(PackLink entity)
	{
		this.SendPropertyChanging();
		entity.Pack = this;
	}
	
	private void detach_PackLinks(PackLink entity)
	{
		this.SendPropertyChanging();
		entity.Pack = null;
	}
	
	private void attach_PackLinks1(PackLink entity)
	{
		this.SendPropertyChanging();
		entity.Pack1 = this;
	}
	
	private void detach_PackLinks1(PackLink entity)
	{
		this.SendPropertyChanging();
		entity.Pack1 = null;
	}
...
public partial class PackLink : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private System.Guid _FromPack;
	
	private System.Guid _ToPack;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnFromPackChanging(System.Guid value);
    partial void OnFromPackChanged();
    partial void OnToPackChanging(System.Guid value);
    partial void OnToPackChanged();
    partial void OnNoteChanging(string value);
    partial void OnNoteChanged();
    #endregion
	...
	[Column(Storage="_FromPack", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
	public System.Guid FromPack
	{
		get
		{
			return this._FromPack;
		}
		set
		{
			if ((this._FromPack != value))
			{
				if (this._Pack.HasLoadedOrAssignedValue)
				{
					throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
				}
				this.OnFromPackChanging(value);
				this.SendPropertyChanging();
				this._FromPack = value;
				this.SendPropertyChanged("FromPack");
				this.OnFromPackChanged();
			}
		}
	}
	
	[Column(Storage="_ToPack", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
	public System.Guid ToPack
	{
		get
		{
			return this._ToPack;
	...
	[Association(Name="Pack_PackLink", Storage="_Pack", ThisKey="FromPack", OtherKey="ID", IsForeignKey=true)]
	public Pack Pack
	{
		get
		{
		...
		set
		{
						...
						|| (this._Pack.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.PackLinks.Remove(this);
				}
				this._Pack.Entity = value;
				if ((value != null))
				{
					value.PackLinks.Add(this);
					this._FromPack = value.ID;
				}
				else
				{
					this._FromPack = default(System.Guid);
				}
	...
	[Association(Name="Pack_PackLink1", Storage="_Pack1", ThisKey="ToPack", OtherKey="ID", IsForeignKey=true)]
	public Pack Pack1
	{
		get
		{
		...
		set
		{
						...
						|| (this._Pack1.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.PackLinks1.Remove(this);
				}
				this._Pack1.Entity = value;
				if ((value != null))
				{
					value.PackLinks1.Add(this);
					this._ToPack = value.ID;
				}
				else
				{
					this._ToPack = default(System.Guid);
				}
